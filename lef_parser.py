...
if __name__ == '__main__':
    path = "osu035_stdcells.lef"
    lef_parser = LefParser(path)
    #lef_parser.get_cell_height()
    lef_parser.parse()

    # test via_dict
    #via1_2 = lef_parser.via_dict["M2_M1"]
    #print (via1_2.layers)
    ...
    #test 2
    and2 = lef_parser.macro_dict["AND2X1"]
    print (and2.info["CLASS"])
        
        
    #via1 = lef_parser.via_dict["via1"]
    #print (via1.layers)
    #for each in via1_2.layers:
       # print (each.name)
    #for lol in lef_parser.via_dict:
        #print (lol)
        #print (lef_parser.via_dict[lol])
